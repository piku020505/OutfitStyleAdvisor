    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center gap-2 text-accent mb-1">
          <Sparkles size={16} />
          <span className="text-xs font-semibold uppercase tracking-wide">AI Style Report</span>
        </div>
      ...
      <p className="text-[11px] text-ink/30 pt-2 border-t border-ink/10">
        Vision backend: {vision_backend} · Report generated by: {style_report.generated_by}
      </p>
    </div>
  )
}
